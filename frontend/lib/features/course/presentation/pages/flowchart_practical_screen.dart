...
class FlowchartPracticalScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FlowchartPracticalScreen> createState() =>
...
class _FlowchartPracticalScreenState extends ConsumerState<FlowchartPracticalScreen> with TickerProviderStateMixin {
        ...
        Expanded(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Check if assignment (contains '=' but not '==', '<=', '>=', '!=')
